...
function cl_objectToString(data){
    var new_string = '';
...
function cl_checkObjectValue(key, value, model){
    
    var field = vc.getParamSettings(model.attributes.shortcode, key);
...
function cl_stringToObject( value ){
...
function($) {
    ...
    _.isUndefined(window.vc) && (window.vc = {}), vc.showSpinner = function() {
        ...
        buildFiltering: function() {
            ...
            item_selector = '[data-vc-ui-element="add-element-button"]', tag = this.model ? this.model.get("shortcode") : "cl_column", not_in = this._getNotIn(tag), $("#vc_elements_name_filter").val(""), this.$content.addClass("vc_filter-all"), this.$content.attr("data-vc-ui-filter", "*");
        ...
        createElement: function(e) {
            ...
            if (!this.preventDoubleExecution) {
                this.preventDoubleExecution = !0, this.do_render = !0, e.preventDefault(), $control = $(e.currentTarget), tag = $control.data("tag"), row_params = {}, row_inner_params = {}, column_params = {
                    width: "1/1"
                }, !1 === this.model && "cl_row" !== tag ? (this.builder.create({
                    shortcode: "cl_row",
                    params: row_params
                }).create({
                    shortcode: "cl_column",
                ...
                }), this.model = this.builder.last()) : !1 !== this.model && "cl_row" === tag && (tag += "_inner");
                var params = {
                    shortcode: tag,
                    parent_id: !!this.model && this.model.get("id"),
                    params: "cl_row_inner" === tag ? row_inner_params : {}
                };
                if (this.prepend) {
                    params.order = 0;
                ...
                "cl_row" === tag ? this.builder.create({
                    shortcode: "cl_column",
                    parent_id: this.builder.lastID(),
                    params: column_params
                }) : "cl_row_inner" === tag && (column_params = {
                    width: "1/1"
                }, this.builder.create({
        ...
        createElement: function(e) {
            ...
            if (!this.preventDoubleExecution) {
                ...
                row_params = {}, column_params = {
                    ...
                    parent_id: row.id,
                    root_id: row.id
                }), model = "cl_row" !== tag ? vc.shortcodes.create({
                    shortcode: tag,
                    parent_id: column.id,
                    root_id: row.id
                }) : row) : "cl_row" === tag ? (row_inner_params = {}, column_inner_params = {
                    width: "1/1"
                }, row = vc.shortcodes.create({
                    shortcode: "cl_row_inner",
    ...
    vc.element_start_index = 0, vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
        ...
        createElement: function(e) {
            ...
            if ($control = $(e.currentTarget), tag = $control.data("tag"), row_params = {}, column_params = {
                ...
                if (vc.storage.lock(), ("cl_slider" === tag || "cl_page_header" === tag )  ) {
                    var modelOptions = {
                        shortcode: tag
                    };
                    preset && ("cl_slider" === presetType || "cl_page_header" === presetType ) && (modelOptions.preset = preset), model = vc.shortcodes.create(modelOptions)
                } else {
                    var rowOptions = {
                        shortcode: "cl_row",
                        params: row_params
                    ...
                    if (preset && "cl_column" === presetType && (columnOptions.preset = preset), column = vc.shortcodes.create(columnOptions), model = row, "cl_row" !== tag) {
                        var options = {
                            shortcode: tag,
                            parent_id: column.id,
                            root_id: row.id
                ...
                } else if ("cl_row" === tag) "cl_slide" === this.model.get("shortcode") ? (vc.storage.lock(), row = vc.shortcodes.create({
                shortcode: "cl_row",
                params: row_params,
                parent_id: this.model.id,
                order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.getNextOrder()
        ...
        createElement: function(e) {
            ...
            if ($control = $(e.currentTarget), tag = $control.data("tag"), row_params = {}, column_params = {
                ...
                if ("cl_slider" === tag || tag === 'cl_page_header') {
                    var modelOptions = {
                        shortcode: tag
                    };
                    preset && ( "cl_slider" === presetType || "cl_page_header" === presetType ) && (modelOptions.preset = preset), this.builder.create(modelOptions), this.model = this.builder.last()
                } else {
                    var rowOptions = {
                        shortcode: "cl_row",
                        params: row_params
                    };
                    preset && "cl_row" === presetType && (rowOptions.preset = preset), this.builder.create(rowOptions);
                    var columnOptions = {
                        shortcode: "cl_column",
                        parent_id: this.builder.lastID(),
                        params: column_params
                    };
                    if (preset && "cl_column" === presetType && (columnOptions.preset = preset), this.builder.create(columnOptions), "cl_row" !== tag) {
                        var options = {
                            shortcode: tag,
                            parent_id: this.builder.lastID()
                        };
                ...
                } else if ("cl_row" === tag) ( "cl_slider" === this.model.get("shortcode") || "cl_page_header" === this.model.get("shortcode") ) ? (this.builder.create({
                shortcode: "cl_row",
                params: row_params,
                parent_id: this.model.id,
...
function($) {
    ...
    vc.ExtendPresets = {
        ...
        showDropdown: function() {
            ...
            window.vc_settings_show && "cl_column" !== tag && this.$el.find('[data-vc-ui-element="settings-dropdown"]').show()
        },
        ...
        getParamsForSettingsPreset: function() {
            ...
            return "cl_column" !== shortcode && "cl_column_inner" !== shortcode || (delete params.width, delete params.offset), params
        }
...
if (vc.memoizeWrapper = function(func, resolver) {
    ...
    }, vc.events.on("shortcodes:cl_row:add:param:name:parallax shortcodes:cl_row:update:param:name:parallax", function(model, value) {
        if (value) {
            var params = model.get("params");
...
window.vc.filters = {
    ...
    function($) {
        ...
        vc.edit_form_callbacks = [], vc.atts = {
            parse: function(param) {
                ...
                if( param.type == 'css_editor' ){
                    var arr = [ 'margin-top', 'margin-bottom', 'margin-left', 'margin-right',
                                'padding-top', 'padding-bottom', 'padding-left', 'padding-right',
                                'border-top-width', 'border-bottom-width', 'border-left-width', 'border-right-width']
                    var $param = this.content().find('[data-vc-shortcode-param-name="'+param.param_name+'"]');
                    var defaultValues = param.value;
                    var new_values = {};
                    _.each(arr, function( key ){
                        var inner_value = $param.find( '[data-name="'+key+'"]' ).val();
                        if(  !_.isUndefined( inner_value ) && !_.isEmpty( inner_value ) )
                            new_values[key] = inner_value;
                    }, this);
                    if(_.isObject(new_values) && !_.isEmpty( new_values )){
       
                        value = cl_objectToString(new_values);
        ...
        vc.atts.textarea_html = {
            ...
            parse: function(param) {
                ...
                return $field.length ? '__array__' + $field.val() + '__array__end__' : null
            },
            render: function(param, value) {
            ...
            parse: function(param) {
                ...
                if( $field.parent().find("li.added").length ){
                    ...
                    mime_type = $field.parent().find("li.added img").attr('data-mime');
                }
            ...
            updateImage: function($thumbnail, image_src, image_exists) {
                $thumbnail.length && (void 0 === image_exists && (image_exists = !1), image_exists || !_.isEmpty(image_src[0]) ? ($thumbnail.attr("src", image_src[0]), $thumbnail.attr('data-mime', image_src[1]), _.isEmpty(image_src[0]) ? ($thumbnail.hide(), $thumbnail.next().removeClass("image-exists").next().addClass("image-exists")) : ($thumbnail.show(), $thumbnail.next().addClass("image-exists").next().addClass("image-exists"))) : $thumbnail.attr("src", "").hide().next().removeClass("image-exists").next().removeClass("image-exists"))
            }
        ...
        }, vc.atts.changeObjectParams = function(model){
            
            var params = _.clone(model.get('params'));
            if( _.isObject( params ) && !_.isEmpty( params ) )
                _.each(params, function(value, key){
                    if( !_.isUndefined(value) && !_.isNull(value) && value.length && cl_checkObjectValue(key, value, model) ){
                        
                        console.log(value);
                        value = cl_stringToObject(value);
                        console.log(value);
        ...
        vc.debug = !1, vc.map = _.isUndefined(window.vc_mapper) ? {} : window.vc_mapper, vc.roles = _.isUndefined(window.vc_roles) ? {} : window.vc_roles, vc.Storage = function() {
            ...
            escapeParam: function(value) {
                ...
                if(_.isObject(value) && !_.isEmpty( value )){
                    ...
                    if( _.isArray( value ) ){
                        ...
                        _.map(value, function(val, index){
                            new_val[index] = val;
                        } );
                        value = new_val;
            ...
            parseContent: function(data, content, parent) {
                ...
                return _.isNull(matches) ? data : (_.each(matches, function(raw) {
                    ...
                    }, map_settings = vc.map[shortcode.shortcode], this.order += 1, data[id] = shortcode, id == shortcode.root_id && (data[id].html = raw), _.isString(sub_content) && sub_content.match(sub_regexp) && (_.isBoolean(map_settings.is_container) && !0 === map_settings.is_container || !_.isEmpty(map_settings.as_parent) && !1 !== map_settings.as_parent) ? data = this.parseContent(data, sub_content, data[id]) : _.isString(sub_content) && sub_content.length && "cl_row" === sub_matches[2] ? data = this.parseContent(data, '[cl_column width="1/1"][cl_text]' + sub_content + "[/cl_text][/cl_column]", data[id]) : _.isString(sub_content) && sub_content.length && "cl_column" === sub_matches[2] ? data = this.parseContent(data, "[cl_text]" + sub_content + "[/cl_text]", data[id]) : _.isString(sub_content) && (data[id].params.content = sub_content)
                }, this), data)
            },
            ...
            wrapData: function(content) {
                ...
                content = wp.shortcode.replace("vc_section", content, function(data) {
                    ...
                    return storage[hash] = {
                        tag: hash,
                        data: toSave
                    }, '[cl_row][vc_pseudo_section id="' + hash + '"][/vc_pseudo_section][/cl_row]'
                });
                ...
                return content = _.reduce(matches, function(mem, value) {
                    -1 !== value.trim().indexOf("vc_pseudo_section_") || value.trim().indexOf("cl_slider") !== -1 || value.trim().indexOf("cl_page_header") !== -1  || value.trim().indexOf("cl_slide") !== -1 || value.trim().indexOf("cl_page_header") !== -1 || value.trim().match(starts_with_shortcode) || (value = "[cl_row][cl_column][cl_text]" + value + "[/cl_text][/cl_column][/cl_row]");
                    var matches_local = value.match(vc_regexp_shortcode());
                    return !_.isArray(matches_local) || _.isUndefined(matches_local[2]) || -1 !== matches_local[2].indexOf("vc_pseudo_section_") || _.isUndefined(vc.map[matches_local[2]]) || !_.isUndefined(vc.map[matches_local[2]].is_container) && vc.map[matches_local[2]].is_container || !_.isEmpty(vc.map[matches_local[2]].as_parent) || (value = "[cl_row][cl_column]" + value + "[/cl_column][/cl_row]"), mem + value
                }, ""), Object.keys(storage).length > 0 && (content = content.replace(/\[cl_row\]\[vc_pseudo_section/g, "[vc_pseudo_section"), content = content.replace(/\[\/vc_pseudo_section\]\[\/cl_row\]/g, "[/vc_pseudo_section]"), content = wp.shortcode.replace("vc_pseudo_section", content, function(data) {
    ...
    function($) {
        vc.clone_index = 1, vc.shortcode_view = Backbone.View.extend({
            ...
            events: {
                ...
                "click .column_edit, .vc_controls-cc > .vc_control-btn-edit.vc_control-btn, .column_edit_trigger": "editElement",
            ...
            saveAsObjectParams: function(model){
            },
            hasUserAccess: function() {
                var shortcodeTag;
                return shortcodeTag = this.model.get("shortcode"), -1 < _.indexOf(["cl_row", "cl_column", "cl_row_inner", "cl_column_inner"], shortcodeTag) || !!_.every(vc.roles.current_user, function(role) {
    ...
    function($) {
        vc.saved_custom_css = !1, vc.visualComposerView = Backbone.View.extend({
            ...
            initialize: function() {
                var _this = this;
                _.bindAll(this, "switchComposer", "dropButton", "processScroll", "updateRowsSorting", "updateElementsSorting"), this.accessPolicy = vc.accessPolicy, this.buildRelevance(), vc.events.on("shortcodes:add", vcAddShortcodeDefaultParams, this), vc.events.on("shortcodes:add", vc.atts.addShortcodeIdParam, this), vc.events.on("shortcodes:add", vc.atts.changeObjectParams, this), vc.events.on("shortcodes:sync", vc.atts.addShortcodeIdParam, this), vc.events.on("shortcodes:sync", vc.atts.changeObjectParams, this), vc.events.on("shortcodes:add", this.addShortcode, this), vc.events.on("shortcodes:destroy", this.checkEmpty, this), vc.shortcodes.on("change:params", this.changeParamsEvents, this), vc.shortcodes.on("reset", this.addAll, this), $(document).on("wp-collapse-menu", function(e, params) {
            ...
            addTextBlock: function(e) {
                ...
                return e.preventDefault(), row_params = {}, row = vc.shortcodes.create({
                    ...
                    parent_id: row.id,
                    root_id: row.id
                }), params = vc.getDefaults("cl_text"), vc.shortcodes.create({
                    shortcode: "cl_text",
                    parent_id: column.id,
                    root_id: row.id,
                    params: params
            ...
            rowSortableSelector: "> .wpb_cl_row, > .vc_main-sortable-element",
    ...
    function($) {
        ...
        window.VcRowView = vc.shortcode_view.extend({
            ...
            getChildTag: function() {
                return "cl_row_inner" === this.model.get("shortcode") ? "cl_column_inner" : "cl_column"
            },
            sortingSelector: "> [data-element_type=cl_column], > [data-element_type=cl_column_inner]",
            ...
            setDropable: function() {
                return this.$content.droppable({
                    greedy: !0,
                    accept: "cl_column_inner" === this.model.get("shortcode") ? ".dropable_el" : ".dropable_el,.dropable_row",
                    hoverClass: "wpb_ui-state-active",
                    drop: this.dropButton
                }), this
            },
            ...
            deleteShortcode: function(e) {
                ...
                this.model.destroy(), parent_id && !vc.shortcodes.where({
                    parent_id: parent_id
                }).length ? (parent = vc.shortcodes.get(parent_id), _.contains(["cl_column", "cl_column_inner"], parent.get("shortcode")) || parent.destroy()) : parent_id && (parent = vc.shortcodes.get(parent_id)) && parent.view && parent.view.setActiveLayoutButton && parent.view.setActiveLayoutButton()
            },
            remove: function() {
