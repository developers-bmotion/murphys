		...
		function add_custom_post_meta(){
			if( class_exists('Cl_Post_Meta') )
				Cl_Post_Meta::map(array(
				   ...
				   'label' => esc_html__('Header Boxed', 'picante'),
				   'priority' => 1,
				   'inline_control' => true,
				   'id' => 'page_header_boxed',
				   'transport' => 'postMessage', 
				   'default' => '', 
				   'description' => esc_html__('Custom Header Option ( Boxed header ) only for this page. This will overwrite the default value on Theme Options -> Header', 'picante')
