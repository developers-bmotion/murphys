				...
				<div class="comment-content post-content" itemprop="text">
					...
					<div class="comment-meta post-meta" role="complementary">
						<div class="comment-author">
							<a class="comment-author-link h5" href="<?php echo esc_url( get_comment_author_url() ); ?>" itemprop="author"><span class="author"><?php comment_author(); ?></span> says:</a>
							<?php comment_reply_link(array_merge( $args, array('reply_text' => '<span>'.esc_html__('Reply', 'picante' ).'</span>', 'add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
							<?php edit_comment_link( esc_html__('Edit this comment','picante' ),'',''); ?>
						</div>
						...
						<p class="comment-meta-item"><?php esc_html_e( 'Your comment is awaiting moderation.', 'picante' ) ?></p>
						<?php endif; ?>
						<?php comment_text() ?>
