...
class CodelessAdsWidget extends WP_Widget{
    ...
    function __construct(){
        ...
        $options = array('classname' => 'widget_ads', 'description' => esc_html__('Add an ad', 'picante' ), 'customize_selective_refresh' => true );
    ...
    function form($instance){
        ...
        <p>
    		...
    		<label for="<?php echo esc_attr( $this->get_field_id('ad_url') ); ?>"><?php esc_html_e( 'Ad URL', 'picante' ) ?>: 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id('ad_img') ); ?>"><?php esc_html_e( 'Ad Image', 'picante' ) ?> (Source): 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id('width') ); ?>"><?php esc_html_e( 'Width', 'picante' ) ?> (ex: 200px): 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id('height') ); ?>"><?php esc_html_e( 'Height', 'picante' ) ?> (ex: 200px): 
