...
class CodelessMostPopularWidget extends WP_Widget{
    ...
    function __construct(){
        ...
        $options = array('classname' => 'widget_most_popular', 'description' => esc_html__('Add a widget to show the most popular posts', 'picante'), 'customize_selective_refresh' => true );
    ...
    function form($instance){
        ...
        <p>
    		...
    		<label for="<?php echo esc_attr( $this->get_field_id('number_of_posts') ); ?>"><?php esc_html_e( 'Number of posts', 'picante' ) ?>: 
