...
class CodelessShortcodeWidget extends Wp_Widget{
 ...
 function __construct(){
        ...
        $options = array('classname' => 'widget_shortcode', 'description' => esc_html__('Add a text widget to show shortcodes', 'picante' ), 'customize_selective_refresh' => true );
 ...
 function form($instance){
        ...
        <p>
         ...
         <p>
    		...
    		<label for="<?php echo esc_attr( $this->get_field_id('content') ); ?>"><?php esc_html_e( 'Text & Shortcodes', 'picante') ?>: 

  <textarea id="<?php echo esc_attr( $this->get_field_id('content') ); ?>" name="<?php echo esc_attr( $this->get_field_name('content') ); ?>" type="text"><?php echo esc_html($content); ?></textarea>
