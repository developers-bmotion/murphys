...
class CodelessContactInfo extends WP_Widget{
    ...
    function widget($atts, $instance){
        ...
        <div class="cl-contact-info">
            ...
            <div class="info"><i class="cl-icon-map-marker-outline"></i><span><?php echo codeless_complex_esc( $address ) ?></span></div>
            <?php endif; ?>

            <?php if( !empty( $phone ) ): ?>
            <div class="info"><i class="cl-icon-cellphone-iphone"></i><span><?php echo codeless_complex_esc( $phone ) ?></span></div>
            <?php endif; ?>

            <?php if( !empty( $email ) ): ?>
            <div class="info email"><i class="cl-icon-email-outline"></i><span><?php echo codeless_complex_esc( $email ) ?></span></div>
            <?php endif; ?>
    ...
    function form($instance){
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id('address') ); ?>"><?php esc_html_e( 'Address', 'picante' ) ?>: 

            <textarea id="<?php echo esc_attr( $this->get_field_id('address') ); ?>" name="<?php echo esc_attr( $this->get_field_name('address') ); ?>"><?php echo codeless_complex_esc($address); ?></textarea>

        </p>

        <p>

            <label for="<?php echo esc_attr( $this->get_field_id('phone') ); ?>"><?php esc_html_e( 'Phone', 'picante' ) ?>: 

            <textarea id="<?php echo esc_attr( $this->get_field_id('phone') ); ?>" name="<?php echo esc_attr( $this->get_field_name('phone') ); ?>"><?php echo codeless_complex_esc($phone); ?></textarea>
